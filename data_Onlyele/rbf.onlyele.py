...
def loops(num=10):    
    ...
    for loop in range(1,num+1):
        print("loop %d... " %(loop))
        data=pd.read_csv(r"./first48-1s-2s-unform.v2.csv",usecols=["Index","Hv30","Co","Cr","Ti","Mo","W"])
        testdata=pd.read_csv(r"./compernent-index.csv",usecols=["Index","Hv30","Co","Cr","Ti","Mo","W"])
