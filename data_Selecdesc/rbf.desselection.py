...
def loops(num=10):    
    ...
    for loop in range(1,num+1):
        ...
        # "delta","RC","entropy","NC","Cr","W","DC","EI","DV","EN"
        cols=["Index","Hv30","delta","entropy","RC","NC","W","Cr","DC","EI","DV",]
        data=pd.read_csv(r"./first48-1s-2s-unform.v2.csv",usecols=cols)
        testdata=pd.read_csv(r"./compernent-index.csv",usecols=cols)
...
#        testdata=pd.read_csv(r"./compernent-index.csv") ##############
#        testdata.drop(["Index"],axis=1,inplace=True) #####################3
#        X=data.drop("Hv30",axis=1)  ###############
